...
ifdef WITH_GOOGLE
    PRODUCT_COPY_FILES += \
	vendor/htc/passion/gapps/BooksPhone.apk:./system/app/BooksPhone.apk \
	...
	vendor/htc/passion/gapps/Twitter.apk:./system/app/Twitter.apk \
	...
	vendor/htc/passion/gapps/kickback.xml:./system/etc/permissions/kickback.xml \
	vendor/htc/passion/gapps/libvoicesearch.so:./system/lib/libvoicesearch.so \
	vendor/htc/passion/gapps/soundback.apk:./system/lib/soundback.apk \
	vendor/htc/passion/gapps/talkback.apk:./system/lib/talkback.apk \
